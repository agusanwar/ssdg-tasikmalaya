...
const columns = [
  ...
  const rows = [
    ...
    createData('6',  'Korwil Depok', '1 Anggota','-'),
    createData('7',  'Korwil Garut', '8 Anggota','-'),
    createData('8', 'Korwil Jakarta Raya', '16 Anggota','-'),
    createData('9', 'Korwil Ngapak Raya', '1 Anggota','-'),
    createData('10', 'Korwil Sukabumi', '11 Anggota','-'),
    createData('12', 'Korwil Sumedang', '9 Anggota','-'),
    createData('13', 'Korwil Tangerang', '21 Anggota','-'),
    createData('14',  'Korwil Tasikmalaya', '41 Anggota','-'),
