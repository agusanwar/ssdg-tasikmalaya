          ...
          <div className='md:left-[10%] max-w-[1100px] m-auto absolute p-4'>      
            <h1 className="text-white mb-4 text-4xl font-extrabold ">
              ...
              <div>
                <Link
                  href="/datakas"
                  className="bg-transparent px-4 mt-5 py-3 text-center text-white hover:bg-color-indigo font-semibold hover:text-white inline-block w-full sm:w-fit border hover:border-transparent border-color-primary rounded-full">
                    Data Iuran KAS
                </Link>
              </div>
              <div className="flex flex-row mt-10">
                <div className="flex ml-5">
                  <motion.div
                    ...
                    whileTap={{  scale: 0.9 }}
                  >
                    <Link href={"https://www.tiktok.com/@ssdg.tasikmalaya"} target="_blank" className="mr-12 transition-all">
                    <svg 
                  ...
                  <motion.div
                    ...
                    whileTap={{  scale: 0.9 }}
                  >
                    <Link href={"https://web.facebook.com/ssdg.korwiltasikmalaya" }target="_blank" className="mr-12 transition-all">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"  
                  ...
                  <motion.div
                    ...
                    whileTap={{  scale: 0.9 }}
                    >
                    <Link href={"https://www.instagram.com/ssdg.korwiltasikmalaya"} target="_blank" className="mr-12 transition-all">
                      <svg 
                        xmlns="http://www.w3.org/2000/svg"  
                        viewBox="0 0 48 48" width="30px" height="30px">
