...
const RegistrasiSituGede = () => { 
    // handling user
    const [title, setTitle] = useState("Liputan Situ Gede Tasikmalaya");
    ...
    // create db
    const dbref = collection(db, "l_situgede")
        ...
        if(anggota.length === 0 || 
          ...
          alert("silahkan lengakapi data anda")
            ...
            try {
                ...
                setTitle("Liputan Situ Gede Tasikmalaya")
                setAnggota("")
                setl1("")
                setl2("")
                setl3("")
      ...
      <div className="min-h-screen flex flex-col items-center justify-center py-2 px-2">
        <div className="max-w-md w-full">
          ...
          <div className="p-8 rounded-2xl bg-white shadow">
            <h2 className="text-gray-800 text-center text-xl font-bold">Web Form Registrasi Situ Gede Tasikmalaya</h2>
...
export default RegistrasiSituGede;
